...
@interface ColorGameViewController : UIViewController <SpeechKitDelegate, SKRecognizerDelegate, UITextFieldDelegate> {
...
@property(nonatomic,retain) IBOutlet UIButton* trainingButton;
